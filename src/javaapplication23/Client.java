...
public class Client {
	...
	public byte[] read(String fileName) throws IOException, NotBoundException{
		...
		//System.out.println(ANSI_RED+"Continutul fisierului "+fileName+": "+ANSI_RESET);
...
//           WriteAck ackMsg = masterStub.
//            
//            fileContent.
//            Files.deleteIfExists("C:\\Users\\Pintea Sergiu\\Documents\\NetBeansProjects\\JavaApplication23\\Replica_0\\");
//            
//            
//        }
